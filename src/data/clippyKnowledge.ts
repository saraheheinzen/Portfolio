  ...
  const chunks: KnowledgeChunk[] = [
    ...
    },
    {
      ...
      text: [
        ...
        'Apps: Games (Steam library), Browser (knowledge base with Featured, Product Design, Games, Inclusive Design, Speaking, and Blog), YouTube (motion library), and Terminal (SarahOS console). Welcome opens a sticky note you can drag around.',
        'Accessibility tools live in the dock settings (contrast, dark mode, text scale, color filters, magnifier, and more).',
        "I'm Clippy — ask me about Sarah, projects, contact, or how to get around.",
      ].join('\n\n'),
